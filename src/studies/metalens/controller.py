"""The CHE-70 convergence sweep controller: one candidate at a time.
    ...
    ./run.sh --gpu python -m studies.metalens.controller \
...
from studies.metalens.oracle import CONFIGURATIONS
...
class SweepController:
    ...
    def manifest(self) -> dict[str, Any]:
        ...
        return {
            ...
            "oracle": {
                ...
                "cross_checks": [
                    "verification.asm_oracle.angular_spectrum_float64 (CHE-40), "
    ...
    def report(self, summary: dict[str, Any]) -> str:
        ...
        lines: list[str] = [
            ...
            "",
            "Generated by `studies.metalens.controller`.",
