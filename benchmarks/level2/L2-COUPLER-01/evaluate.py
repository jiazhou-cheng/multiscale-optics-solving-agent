#!/usr/bin/env python3
"""L2-COUPLER-01 evaluator — re-check a bundle against its own recorded hashes.
...
A benchmark that cannot notice a corrupted artifact cannot certify one, so this
is run by the benchmark itself against a deliberately mutated copy, and the
observed exit code is what gets recorded -- never a hardcoded expectation.
"""
