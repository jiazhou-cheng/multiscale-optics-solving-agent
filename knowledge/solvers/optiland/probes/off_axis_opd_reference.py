...
Run inside the agent_solver container:
    ./run.sh python knowledge/solvers/optiland/probes/off_axis_opd_reference.py
    ./run.sh python knowledge/solvers/optiland/probes/off_axis_opd_reference.py \
        --write-expected knowledge/solvers/optiland/expected/off_axis_opd_reference.json
"""
