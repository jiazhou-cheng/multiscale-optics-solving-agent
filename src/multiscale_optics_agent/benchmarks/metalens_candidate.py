...
Run as a module, never imported by the controller's own process:
    ...
    python -m multiscale_optics_agent.benchmarks.metalens_candidate \
...
from multiscale_optics_agent.core.resources import (
    MemoryWatchdog,
...
def run_candidate(request: CandidateRequest) -> dict[str, Any]:
    ...
    from multiscale_optics_agent.couplers.contracts import PSF, ReferencePlane
    from multiscale_optics_agent.couplers.ray_to_wave import Projection
    ...
    from multiscale_optics_agent.couplers.wave_to_ray import SamplingDensity, decompose
...
def _host(array: Any) -> np.ndarray:
    ...
    from multiscale_optics_agent.core.arrays import to_host_numpy
