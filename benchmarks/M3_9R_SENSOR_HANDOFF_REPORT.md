...
**Issue:** CHE-38 (M3.9R) · **Probe:** `benchmarks/probes/m3r_sensor_handoff.py`
...
| slice protocol | `benchmarks/slice_protocol.yaml`, `benchmarks/M3_SLICE_PROTOCOL.md` |
| this report | `benchmarks/M3_9R_SENSOR_HANDOFF_REPORT.md` |
