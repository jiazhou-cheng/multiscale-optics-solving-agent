"""The CHE-70 convergence sweep controller: one candidate at a time.
    ...
    ./run.sh --gpu python -m multiscale_optics_agent.benchmarks.metalens_controller \
...
from multiscale_optics_agent.evaluation.metalens import CONFIGURATIONS
...
class SweepController:
    ...
    def launch(self, request: CandidateRequest) -> dict[str, Any]:
        ...
        command = [
            sys.executable,
            "-m",
            "multiscale_optics_agent.benchmarks.metalens_candidate",
            "--config",
            request.config,
            "--launch-count",
    ...
    def reproduction_command(self) -> str:
        ...
        return (
            "./run.sh --gpu python -m multiscale_optics_agent.benchmarks."
    ...
    def report(self, summary: dict[str, Any]) -> str:
        ...
        lines: list[str] = [
            ...
            "",
            "Generated by `multiscale_optics_agent.benchmarks.metalens_controller`.",
