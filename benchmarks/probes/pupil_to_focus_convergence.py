...
#: back from benchmarks/protocols/slice_protocol.yaml by :func:`_check_frozen_configuration`
...
def _rusage_is_inherited_through_fork() -> dict[str, Any]:
    ...
    return {
        ...
        "protocol_note": (
            "benchmarks/protocols/protocol.yaml names ru_maxrss as the preferred method. That "
...
def _check_frozen_configuration(protocol: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "source": "benchmarks/protocols/slice_protocol.yaml",
